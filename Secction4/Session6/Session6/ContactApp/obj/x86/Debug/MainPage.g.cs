#pragma checksum "D:\Aptech\FE\T1902E\Sem3\WFP\Session6\ContactApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "19A0FE430DDB3ACA579E45DF33A801F0"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace ContactApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ContactApp.Models.Contact dataRoot;
            ...
            {
                if (lineNumber == 35 && columnNumber == 50)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::ContactApp.Models.Contact) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ContactApp.Models.Contact)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::ContactApp.Models.Contact obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::ContactApp.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 30 && columnNumber == 31)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::ContactApp.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::ContactApp.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Contacts(global::System.Collections.ObjectModel.ObservableCollection<global::ContactApp.Models.Contact> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
