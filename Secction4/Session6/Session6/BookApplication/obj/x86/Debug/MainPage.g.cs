#pragma checksum "D:\Aptech\FE\T1902E\Sem3\WFP\Session6\BookApplication\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "B806DD5D399D3186AB0FC1C055A93E39"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace BookApplication
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj2_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::BookApplication.Models.Book dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::BookApplication.Models.Book) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::BookApplication.Models.Book)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::BookApplication.Models.Book obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::BookApplication.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::BookApplication.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::BookApplication.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::BookApplication.Models.Book> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 7: // MainPage.xaml line 37
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.ListBox)this.BooksListBox).SelectionChanged += this.ListBox_SelectionChanged;
                }
                break;
            default:
                break;
